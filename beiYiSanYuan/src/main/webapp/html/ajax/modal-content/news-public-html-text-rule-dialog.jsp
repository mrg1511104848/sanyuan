...
<div  title="Dialog Simple Title" class="col-sm-12" id="" style="min-width:600px;height:570px;overflow-y: scroll;">
	...
	<fieldset>
			...
			<c:if test="${publicTextRule.textReplyParserMap == null}">
			...
			<c:if test="${publicTextRule.textReplyParserMap != null}">
				<c:forEach var="replyParserMap" items="${publicTextRule.textReplyParserMap }" varStatus="s">
					<div class="form-group" name="textReplyParserMap">
						<c:if test="${s.index==0}"> 
								<label class="control-label col-md-2">
									回复
			...
			<c:if test="${publicTextRule.textClickParserMap == null}">
			...
			<c:if test="${publicTextRule.textClickParserMap != null}">
				<c:forEach var="clickParserMap" items="${publicTextRule.textClickParserMap }" varStatus="s">
					<div class="form-group" name="textClickParserMap">
						<c:if test="${s.index==0}"> 
										<label class="control-label col-md-2">
											点击
