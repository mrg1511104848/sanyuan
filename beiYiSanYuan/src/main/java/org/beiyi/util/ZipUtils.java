...
public class ZipUtils {
    ...
    public static void toZip(String srcDir, String outDir,
    	...
    	toZip(new String[]{srcDir}, outDir, KeepDirStructure);
    }
    /**
     * @param srcDir 压缩文件夹路径
     * @param out 压缩文件输出流
     ...
     * @throws RuntimeException 压缩失败会抛出运行时异常
     */
    public static void toZip(String[] srcDirs, String outDir,
            boolean KeepDirStructure) throws RuntimeException, Exception {
    ...
    public static void main(String[] args) {
		try {
			toZip("C://apache-tomcat-7.0.54-2/webapps/beiYiSanYuan/chufangs_export20180627212945332/", "C://apache-tomcat-7.0.54-2/webapps/beiYiSanYuan/chufangs_export20180627212945332.zip", true);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
